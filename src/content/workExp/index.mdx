  ...
  - employer: 'Merkle <span class="text-gray-400">(Dentsu International)</span>'
    ...
    positions:
      - title: 'Technical Lead, Front-End Engineering - Commerce'
        ...
        end_date: 'Feb 2025'
        notes:
          - 'Role expanded to include project architecture, working directly with project managers  and clients to define requirements and development approach.'
          - 'Lead front-end site development during site implementation'
