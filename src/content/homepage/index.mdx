...
summary: 'Lorem ipsum odor amet, consectetuer adipiscing elit. Ullamcorper curabitur ut risus libero curae habitasse conubia. Interdum morbi consectetur suscipit enim platea interdum ad cursus. Taciti justo fermentum est ad justo fringilla semper arcu etiam. Bibendum accumsan fringilla feugiat, suscipit nostra fames. Sem eu luctus rhoncus magnis libero eros fermentum tempus. Phasellus ornare cubilia vestibulum eget fames vulputate lacus curae. Natoque mus ultricies vestibulum; montes a ante maecenas porttitor.'

banner:
  title: '<span class="text-secondary">Web Development</span> is my <span class="text-accent text-shadow-[0px_5px_15px] shadow-accent/10">passion</span>.'
  title_size: "text-4xl md:text-6xl"
  content: '"Make what you love doing your job, and you&apos;ll never work a day in your life"'
  image: /images/logo_v5_xl_pfp.webp
  buttons:
    - label: Connect with me
      href: "https://www.linkedin.com/in/andrewchap/"
      target: "_blank"
      icon: linkedin
      color: primary
      addClasses: "w-full text-white hover:bg-accent dark:border-white/10 dark:border"
...
sections:
  ...
  - title: Looks great, day or night
    content: "With <b class='text-accent'>built-in dark theme support</b>, your site will look amazing no matter what time of day your users visit. Or what their eyes prefer.<br/> <br/>Forget convoluted theming systems. Focus on your design and let the code work for you."
