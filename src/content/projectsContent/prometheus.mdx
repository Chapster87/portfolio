...
<div class="prose dark:prose-invert max-w-full">
  ...
  <p>Please keep in mind this is very much a sandbox project for me. I try not to push up broken code, but it happens. React Expo is cumbersome, and held back by React Native constraints. I can't help but think I could rebuild it faster in something more modern.</p>
  <p>Currently not mobile friendly, please view in a browser.</p>
  <p class="font-bold">UPDATE: Currently rebuilding from scratch in TanStack w/ Router & Query packages.</p>
</div>