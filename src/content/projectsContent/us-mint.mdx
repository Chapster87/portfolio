...
<div class="prose max-w-full">
  <p>wWen we started the U.S. Mint project, it was touted regularly that the current held the record for the most transactions in a minute across all Salesforce Commerce Cloud clients. The Mint's bread-and-butter is their massive coin drops that generate a massive amount of traffic and orders. Efficiency and optimization were under the microscope. The site needed to be fast, and it needed to work every single time.</p>
  ...
  <ul>
    ...
    <li>Products & Categories</li>
      <ul>
        ...
        <li>Product Schedule Category Page</li>
          <ul>
