...
image_hero: '/images/projects/usmint-website.webp'
image_thumb: '/images/projects/usmint-thumb.webp'
---

<div class="prose max-w-full">
  <p>It was touted regularly when we started the project that the U.S. Mint held the record for the most transactions in a minute across all Salesforce Commerce Cloud clients. The Mint's bread-and-butter is their massive coin drops that generate a massive amount of traffic and orders. Efficiency and optimization were under the microscope. The site needed to be fast, and it needed to work every single time.</p>
