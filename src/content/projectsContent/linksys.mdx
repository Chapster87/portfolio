...
<div class="prose max-w-full">
  ...
  <p>In the end, the client was extremely pleased with both the site and <a class="link-primary font-bold" href="https://web.archive.org/web/20220816213335/https://www.linksys.com/" target="_blank">the homepage</a>. While I got a new skill to add to my toolkit.</p>
  <p class="text-lg font-bold">Notable customizations</p>
  <ul>
    <li>Parallax Animation Capabilities</li>
      <ul>  
    ...
    <li>Full custom Homepage Template including Parallax Animated section interwoven with Page Designer enabled regions for client merchandising</li>
  </ul>
</div>